...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        twitterLoginButton = (Button) findViewById(R.id.login_button);
        headerText = (TextView) findViewById(R.id.header_text);
        headerText.setTypeface(FontCache.get("font/LoveYaLikeASister.ttf", this));
        ...
        if (isLoggedIn) {
            ...
            Toast.makeText(this, msg + username, Toast.LENGTH_SHORT).show();
    ...
    private void GoToNonFollowers() {
        Intent intent = new Intent(this, NonFollowers.class);
